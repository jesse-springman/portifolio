...
export const HeaderAll = () => {
  ...
  return (
    <UlHeader>
      ...
      <LiHeader
        data-testid="liProjeto"
        onClick={() => scrollSecao('refProjeto')}
      >
        Projetos
      </LiHeader>

      <LiHeader data-testid="liSoft" onClick={() => scrollSecao('refSkills')}>
        Soft-Skills
      </LiHeader>

      <LiHeader data-testid="liContato" onClick={() => scrollSecao('refCont')}>
        Contatos
      </LiHeader>
    </UlHeader>
  );
